...
4) **Light social hubs + identity** (cosmetics/status items paired with small activities).
...
- Count: **21**
- Ranks: #1, #2, #3, #5, #6, #7, #8, #10, #11, #12, #13, #14, #15, #17, #18, #19, #20, #21, #22, #23, #24
